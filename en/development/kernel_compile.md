...
1. Refer to Buildroot's [Development Environment](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/buildroot/source.md) to set up the cross-compiler.
