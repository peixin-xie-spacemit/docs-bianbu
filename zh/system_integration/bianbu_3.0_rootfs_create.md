...
GNOME, LXQt 和 NAS 都是基于 Minimal 的，建议先安装 Minimal 元包再安装相应元包。
...
注意：关于 rootfs.ext4 大小。bianbu-minimal 推荐 2048M， Bianbu GNOME 桌面版本推荐 8192M，Bianbu LXQt 桌面版本推荐 6144M
